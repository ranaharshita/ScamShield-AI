...
import { Shield, Mail, Lock, Eye, EyeOff, AlertCircle, ArrowRight, ShieldCheck, Zap } from "lucide-react";
...
function InputField({ icon: Icon, type = "text", placeholder, value, onChange, required, suffix, id }: {
  icon: React.ElementType; type?: string; placeholder: string;
  value: string; onChange: (v: string) => void; required?: boolean;
  suffix?: React.ReactNode; id?: string;
}) {
  return (
  ...
  return (
    <div className="flex min-h-screen bg-[var(--bg)]">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-14 relative overflow-hidden">
        ...
        <div className="pointer-events-none absolute top-1/3 left-1/2 -translate-x-1/2 h-64 w-64 rounded-full bg-[var(--accent)] opacity-[0.05] blur-3xl" />
        ...
        <div className="relative space-y-8">
          <div>
            ...
            <p className="mt-4 text-[var(--text-muted)] leading-relaxed">
              AI-powered scam detection in seconds. Trusted, private, and built for everyone.
            </p>
          </div>
